@cmd install married.js module.exports = {
    config: {
        name: "marry2",
        aliases: ["married"],
        version: "1.0",
        author: "kivv (fixed Aesther)",
        countDown: 5,
        role: 0,
    ...
    makeImage: async function ({ one, two }) {
        ...
        batgiam_img.composite(circleOne.resize(130, 130), 203, 69).composite(circleTwo.resize(130, 130), 103, 160);
