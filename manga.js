@cmd install manga.js const axios = require('axios');
      ...
      if (type == "search") {
        ...
        if (type == 'read') {
          ...
          api.setMessageReaction('⏳', event.messageID, async () => {
            try {
              const response = await axios.get("https://nash-rest-api.vercel.app/manga-search?title=" + chapterData.id);
